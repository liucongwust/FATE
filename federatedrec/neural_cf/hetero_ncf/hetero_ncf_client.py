...
class HeteroNCFClient(HeteroNCFBase):
    ...
    def fit(self, data_instances, validate_data=None):
        ...
        # user num may be the max user index
        user_num = data.user_count + 1
        ...
        self._model = NCFModel.build_model(self.user_num, item_num, self.params.init_param.embed_dim,
                                           self.loss, self.optimizer, self.metrics, mlp_params=self.params.mlp_params)
    ...
    def _get_param(self):
        from federatedrec.protobuf.generated import ncf_model_param_pb2
    ...
    def predict(self, data_inst):
        ...
        LOGGER.debug(f"predict results: {kv}")
    ...
    def _load_model(self, model_dict):
        ...
        self._model = NCFModel.restore_model(model_obj.saved_model_bytes)
